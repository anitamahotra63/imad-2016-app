        ...
        request.onreadystatechange = function () {
          if (request.readyState === XMLHttpRequest.DONE) {
              ...
              if (request.status === 200) {
                  ...
                  document.getElementById('upper').innerHTML=`<span style="font-family:Gabriola; font-size:xx-large; margin-left:500px; color:white "><strong> You are logged in!</strong><input type="submit" id="logout" value="Log Out"/> </span>`;
                  loadArticles();
              } else {
